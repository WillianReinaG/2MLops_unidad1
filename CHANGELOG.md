...
Diagrama de referencia del curso: [healthPrediction-mlops-U2, `entrega3`](https://github.com/rchicangana/healthPrediction-mlops-U2/tree/entrega3).
...
El servicio MVP (`servicio_estado_clinico/`) se mantiene como **baseline implementado** de Semana 1; la Unidad 3 documenta la evolución propuesta, no reescribe la lógica de inferencia en este entregable.
